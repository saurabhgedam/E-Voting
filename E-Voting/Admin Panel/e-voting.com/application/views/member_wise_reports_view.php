              ...
              <div class="span12">
                <div class="widget">
                  <div class="widget-header">
                    <div class="title">
                      <form action="<?php echo site_url('reports/show_member_wise_reports '); ?>" method="POST" class="navbar-form">
                        <select  name="member_id" id="member_id" class="chosen-select" required>
                          <option value="">
                            Select Member
                          </option>
                          <?php foreach ($members as $member) { ?>
                            <option value="<?php echo $member->id; ?>" <?php //echo (set_value('project') == $project->id ? 'selected' : ''); ?> >
