                  ...
                  <div class="widget-header">
                    ...
                    <?php if(!empty($projects)){ ?>                    
                      <form action="<?php echo site_url('mlm/show_project_tree'); ?>" method="POST" class="navbar-form">
                           <select  name="project_id" id="project_id" class="span4 chosen-select" required>
                              <option value="">
                                Select Project
                              </option>
                    ...
                    echo '<div style="float:left;width:'.$width.'%">
                            <center>
                              <a  class="btn btn-success" >
                                '.$tree[0]['project_name'].' ('.$total_tree_members.')<br>(Level '.$tree[0]['depth_level'].')
                              </a>
                              <div style="height: 20px;border-style: dotted;width: 0px;"></div>
                            </center>
                          </div>';
                      ...
                      if ($tree[$i]['depth_level']==0) {
                        echo '<div style="float:left;width:'.$width.'%">
                            <center>
                              ...
                              <a  href="'.site_url('mlm/show_member_tree/'.$tree[$i]['project_id'].'/'.$tree[$i]['member_id']).'" class="btn btn-success bottom-margin" title="'.$tree[$i]['member_name'].'">
