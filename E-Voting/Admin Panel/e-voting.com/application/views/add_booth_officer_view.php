              ...
              <div class="span12">
                <div class="widget">
                  <div class="widget-header">
                    <div class="title">
                      Create Booth Officer Account 
                      <span class="mini-title">
                        Form for new booth_officer
                      </span>
                    </div>
                    <span class="tools">
                  ...
                  <div class="widget-body">
                    ...
                    <form action="<?php echo site_url('booth_officers/add_booth_officer'); ?>" method="POST" enctype="multipart/form-data" class="form-horizontal no-margin">
                      <h5>
                      ...
                      <div class="control-group">
                        ...
                        <div class="controls">
                          <input type="mobile" id="mobile" name="mobile" value="<?php echo set_value('mobile'); ?>" pattern="\d{10}" class="span6" placeholder="Enter Mobile Number"  required/>
                        </div>
                      </div>
                      <div class="control-group">
                      ...
                      <div class="form-actions no-margin">
                        <button type="submit" name="add_booth_officer" value="add_booth_officer" class="btn btn-info pull-right">
